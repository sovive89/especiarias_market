import { Bell, ChevronRight, CircleUserRound, LocateFixed, LogOut, Phone, type LucideIcon } from "lucide-react";
import { Badge, Button, PageHeader, Surface } from "../components/ui";
import { useDriver } from "../context/DriverContext";

function SettingRow({ icon: Icon, title, value }: { icon: LucideIcon; title: string; value: string }) {
  return (
    <li className="setting">
      <span className="setting__icon"><Icon size={18} /></span>
