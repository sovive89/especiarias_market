...
const deliveries: Delivery[] = [
  {
    id: "del-001", orderId: "ord-001", driverId: driver.id, routeId: "route-001", sequence: 1, status: "READY",
    customerName: "Marina Costa", customerPhone: "+5561991111111", address: "SQN 210, Bloco C — Asa Norte, Brasília",
    complement: "Apto 302", notes: "Interfone 302", trackingEnabled: false, distanceKm: 3.2, etaMinutes: 9
  },
  {
    id: "del-002", orderId: "ord-002", driverId: driver.id, routeId: "route-001", sequence: 2, status: "ASSIGNED",
    customerName: "João Pereira", customerPhone: "+5561992222222", address: "SQS 308, Bloco B — Asa Sul, Brasília",
    complement: "Bloco B, apto 104", notes: "", trackingEnabled: false, distanceKm: 5.1, etaMinutes: 15
  },
  {
    id: "del-003", orderId: "ord-003", driverId: driver.id, routeId: "route-001", sequence: 3, status: "ASSIGNED",
    customerName: "Ana Ribeiro", customerPhone: "+5561993333333", address: "SHIS QI 11, Conjunto 4 — Lago Sul, Brasília",
    complement: "Casa 14", notes: "Portão lateral", trackingEnabled: false, distanceKm: 7.4, etaMinutes: 22
  }
];
...
export const mockApi: DriverDataSource = {
  async getDriver() { return clone(driver); },
  async getRoute() { return clone(route); },
  async getDeliveries() { return clone(deliveries); },
  async getEvents() { return clone(events); },
